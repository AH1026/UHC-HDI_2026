...
need_cols <- c("Region","UHC SCI","RMNCH","ID","NCD","SCA","HDI")
...
ggsave(
  filename = file.path(out_dir, "Figure2_Region6_with_HDI.tiff"),
  plot = fig_region6,
  device = "tiff",
  dpi = 300,
  width = 12,
...
openxlsx::saveWorkbook(wb, file = file.path(out_dir, "Figure2_Region_medians.xlsx"), overwrite = TRUE)
