...
figs <- list(
  list(col="UHC SCI", label="UHC SCI", y_lim=c(0, 10),  tiff="S1Fig_GEE_YearSlopes_UHCSCI.tiff"),
  list(col="RMNCH",   label="RMNCH",   y_lim=c(-2, 18), tiff="S2Fig_GEE_YearSlopes_RMNCH.tiff"),
  list(col="ID",      label="ID",      y_lim=c(-2, 18), tiff="S3Fig_GEE_YearSlopes_ID.tiff"),
  list(col="NCD",     label="NCD",     y_lim=c(-2, 18), tiff="S4Fig_GEE_YearSlopes_NCD.tiff"),
  list(col="SCA",     label="SCA",     y_lim=c(-2, 18), tiff="S5Fig_GEE_YearSlopes_SCA.tiff")
)
...
excel_out <- file.path(out_dir, "S1-5Figs_GEE_YearSlopes_All.xlsx")
