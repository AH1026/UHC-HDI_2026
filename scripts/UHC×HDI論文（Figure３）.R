...
out_dir <- "UHC×HDI論文_output：Figure３"
...
out_plot <- file.path(out_dir, "Figure3_GEE_independence_300dpi.tiff")
ggsave(out_plot, p_all, device = "tiff", dpi = 300, width = 9, height = 15, units = "in", compression = "lzw")

xlsx_out <- file.path(out_dir, "Figure3_GEE_independence_results.xlsx")
writexl::write_xlsx(
  list(
    "HDI" = o1$data,
    "GNI_index" = o2$data,
